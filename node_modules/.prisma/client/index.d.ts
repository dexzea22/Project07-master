  ...
  */
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        P extends 'user' ? User_InfoGetPayload<S['include'][P]> | null :  never
  } 
    : S extends { select: any } & (UserArgs | UserFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? User_InfoGetPayload<S['select'][P]> | null :  P extends keyof User ? User[P] : never
  } 
      : User
  ...
  export class Prisma__UserClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    user<T extends User_InfoArgs= {}>(args?: Subset<T, User_InfoArgs>): Prisma__User_InfoClient<User_InfoGetPayload<T> | Null>;
  ...
  export type User_InfoGetPayload<S extends boolean | null | undefined | User_InfoArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? User_Info :
    S extends undefined ? never :
    S extends { include: any } & (User_InfoArgs | User_InfoFindManyArgs)
    ? User_Info  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'user' ? UserGetPayload<S['include'][P]> | null :  never
  } 
    : S extends { select: any } & (User_InfoArgs | User_InfoFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> | null :  P extends keyof User_Info ? User_Info[P] : never
  } 
      : User_Info


  type User_InfoCountArgs = 
    Omit<User_InfoFindManyArgs, 'select' | 'include'> & {
      select?: User_InfoCountAggregateInputType | true
    }

  export interface User_InfoDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'User_Info'> extends True ? Prisma__User_InfoClient<User_InfoGetPayload<T>> : Prisma__User_InfoClient<User_InfoGetPayload<T> | null, null>
    ...
    **/
    ...
    ): Prisma__User_InfoClient<User_InfoGetPayload<T>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'User_Info'> extends True ? Prisma__User_InfoClient<User_InfoGetPayload<T>> : Prisma__User_InfoClient<User_InfoGetPayload<T> | null, null>
    ...
    **/
    ...
    ): Prisma.PrismaPromise<Array<User_InfoGetPayload<T>>>
    ...
    **/
    ...
    /**
     * Find zero or more User_Infos that matches the filter.
     * @param {User_InfoFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const user_Info = await prisma.user_Info.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
    **/
    findRaw(
      args?: User_InfoFindRawArgs
    ): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a User_Info.
     * @param {User_InfoAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const user_Info = await prisma.user_Info.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
    ...
    **/
    aggregateRaw(
      args?: User_InfoAggregateRawArgs
    ): Prisma.PrismaPromise<JsonObject>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__User_InfoClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
   ...
   */
  export type User_InfoFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the User_Info
     */
    select?: User_InfoSelect | null
   ...
   */
  export type User_InfoFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the User_Info
     */
    select?: User_InfoSelect | null
   ...
   * User_Info findRaw
   */
  export type User_InfoFindRawArgs = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * User_Info aggregateRaw
   */
  export type User_InfoAggregateRawArgs = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type UserWhereInput = {
    ...
    user?: XOR<User_InfoRelationFilter, User_InfoWhereInput> | null
  }
  ...
  export type UserCreateInput = {
    ...
    password?: string | null
    usertype?: string | null
    user?: User_InfoCreateNestedOneWithoutUserInput
  }
  ...
  export type UserUncheckedCreateInput = {
    ...
    password?: string | null
    usertype?: string | null
    user?: User_InfoUncheckedCreateNestedOneWithoutUserInput
  }
  ...
  export type UserUpdateInput = {
    ...
    user?: User_InfoUpdateOneWithoutUserNestedInput
  }
  ...
  export type UserUncheckedUpdateInput = {
    ...
    password?: NullableStringFieldUpdateOperationsInput | string | null
    usertype?: NullableStringFieldUpdateOperationsInput | string | null
    user?: User_InfoUncheckedUpdateOneWithoutUserNestedInput
  }
  ...
  export type User_InfoCreateNestedOneWithoutUserInput = {
    ...
    connectOrCreate?: User_InfoCreateOrConnectWithoutUserInput
  ...
  export type User_InfoUpdateOneWithoutUserNestedInput = {
    create?: XOR<User_InfoCreateWithoutUserInput, User_InfoUncheckedCreateWithoutUserInput>
    connectOrCreate?: User_InfoCreateOrConnectWithoutUserInput
    upsert?: User_InfoUpsertWithoutUserInput
    disconnect?: boolean
    delete?: boolean
    connect?: User_InfoWhereUniqueInput
